...
<?php
	...
	if(!empty($_POST['create_post_btn'])){
		$photo=$_FILES['photo'];
		...
		if(empty($photo['name'])){
			...
			if($photo['type'] != "image/jpeg"){
				$photo_type_error='*The file you selected is not a supported format';
			}
			else{
				...
				try {
					...
					$sql = "INSERT INTO posts (caption, image) VALUES (:caption, :photo)";
					...
					echo "<script>alert('The post has been published')</script>" . $conn->lastInsertId();
				}
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <form method="post">
                  	<input type="submit" class="btn btn-default btn-flat" value="Sign Out" name="sign_out_btn">
                  </form>
                </div>
              </li>
            </ul>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="dashboard.html"><i class="fa fa-home" aria-hidden="true"></i> <span>Home</span></a></li>
        <li><a href="posts.html"><i class="fa fa-bars" aria-hidden="true"></i> <span>Posts</span></a></li>
        <li>
          <a href="chat.html">
        ...
        <li class="header">AVAILABILITY STATUS</li>
        <li><a href="#"><i class="fa fa-circle-o text-red"></i> <span>Offline</span></a></li>
        <li><a href="#"><i class="fa fa-circle-o text-yellow"></i> <span>Away</span></a></li>
        <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>Online</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
...
<div class="box box-warning">
            ...
            <form method="post" enctype="multipart/form-data" class="box-body">
                ...
                <div class="form-group">
                  <label>Friends</label>
                  <input type="text" class="form-control" placeholder="Tag your friends">
                </div>
                <label>Location</label>
                <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-globe"></i></span>
                <input type="email" class="form-control" placeholder="Input your location">
              </div>
               <div class="form-group">
                  <label for="exampleInputFile">Image upload</label>
                  <input name="photo" type="file">
					<div class="text-danger"><?php echo($photo_error) ?> <?php echo($photo_type_error) ?></div>
                  <input type="ty" class="btn btn-danger" value="Dropdown">
                </div>
                <div class="box-footer">
                <input type="submit" class="btn btn-primary" value="Post!" name="create_post_btn">
              </div>
